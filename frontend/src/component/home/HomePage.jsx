...
const HomePage = () => {
    ...
    return (
        <div className="home">
            ...
            <section>
                <header className="header-banner">
                    ...
                    <div className="animated-texts overlay-content">
                        <h1>
                            Welcome to <span className="phegon-color">Siddhi Hotels</span>
                        </h1><br />
                        <h3 style={{ textAlign: "center" }}>
                            Experience a space designed for your peace and care.
                        </h3>
                    </div>
                </header>
            </section>
            ...
            <h2 className="home-services">Services at <span className="phegon-color">Siddhi Hotels</span></h2>
