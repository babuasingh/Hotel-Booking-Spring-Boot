...
const RoomDetailsPage = () => {
  ...
  const { roomType, roomPrice, photoURL, roomDescription, bookings } = roomDetails;
  ...
  return (
    <div className="room-details-booking">
      ...
      <h2>Room Details</h2>
      <br />
      <img src={photoURL} alt={roomType} className="room-details-image" />
